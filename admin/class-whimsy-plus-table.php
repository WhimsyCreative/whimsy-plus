...
class TT_Example_List_Table extends WP_List_Table {
	...
	public function get_columns() {
		$columns = array(
			...
			'title'    => _x( 'Title', 'Column label', 'whimsy-plus' ),
			'director' => _x( 'Director', 'Column label', 'whimsy-plus' ),
		);
	...
	protected function column_title( $item ) {
		...
		$actions['activate'] = sprintf(
			...
			_x( 'Activate', 'List table row action', 'whimsy-plus' )
		);
		...
		$actions['deactivate'] = sprintf(
			...
			_x( 'Deactivate', 'List table row action', 'whimsy-plus' )
		);
	...
	protected function get_bulk_actions() {
		$actions = array(
			'deactivate' => _x( 'deactivate', 'List table bulk action', 'whimsy-plus' ),
		);
