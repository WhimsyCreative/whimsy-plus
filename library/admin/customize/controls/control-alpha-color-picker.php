...
if ( !class_exists( 'Whimsy_Alpha_Color_Control' ) ) {
    class Whimsy_Alpha_Color_Control extends WP_Customize_Control {
        ...
        public function enqueue() {
            wp_enqueue_script(  'alpha-color-picker', WHIMSY_EXTEND_JS   . 'alpha-color-picker.js', array( 'jquery', 'wp-color-picker' ), '1.0.0', true );
            wp_enqueue_style(   'alpha-color-picker', WHIMSY_EXTEND_CSS  . 'alpha-color-picker.css', array( 'wp-color-picker' ), '1.0.0' );
        }
