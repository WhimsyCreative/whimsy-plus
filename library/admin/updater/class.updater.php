<?php
    ...
    class WHIMSY_UPDATER_AUTO_UPDATER
         {
    ...
    function whimsy_updater_run_updater()
         {
         
             $wp_plugin_auto_update = new WHIMSY_UPDATER_AUTO_UPDATER( WHIMSY_UPDATER_APP_API_URL, 'whimsy-plus', 'whimsy-plus/whimsy-plus.php' );
    ...
    add_action( 'after_setup_theme', 'whimsy_updater_run_updater' );
