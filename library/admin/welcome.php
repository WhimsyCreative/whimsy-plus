...
class Whimsy_Plus_Welcome {
	...
	public function about_screen() {
		...
		<div class="wrap about-wrap whimsy-framework-wrap">
			...
			<div class="changelog">
				...
				<div class="feature-section">
					<div class="feature-section-media">
						<img src="<?php echo WHIMSY_PLUS_URI . 'assets/images/screenshots/26-customer.png'; ?>"/>
					</div>
			...
			<div class="changelog">
				<h3><?php _e( 'Native Import Options', 'whimsy-plus' );?></h3>
				<div class="feature-section">
					<div class="feature-section-media">
						<img src="<?php echo WHIMSY_PLUS_URI . 'assets/images/screenshots/26-import.png'; ?>"/>
					</div>
					<div class="feature-section-content">
			...
			<div class="changelog">
				...
				<div class="feature-section">
					<div class="feature-section-media">
						<img src="<?php echo WHIMSY_PLUS_URI . 'assets/images/screenshots/26-refund.png'; ?>" class="whimsy-welcome-screenshots alignleft"/>
					</div>
					<div class="feature-section-content">
			...
			<div class="changelog">
				...
				<div class="feature-section three-col">
					...
					<div class="col">
						...
						<p><?php _e( 'When embWhimsy Frameworking a download product on another site, using WordPress core’s oEmbed feature, the product prices are now shown.', 'whimsy-plus' );?></p>
					</div>
					<div class="col">
